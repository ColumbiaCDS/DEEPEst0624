...
#include "stanExports_Stan_Time_Hier.h"

RCPP_MODULE(stan_fit4Stan_Time_Hier_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Stan_Time_Hier")
