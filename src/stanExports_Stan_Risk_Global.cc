...
#include "stanExports_Stan_Risk_Global.h"

RCPP_MODULE(stan_fit4Stan_Risk_Global_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Stan_Risk_Global")
